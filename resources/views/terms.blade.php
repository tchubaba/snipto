...
@section('content')
    <div class="max-w-3xl mx-auto py-12 px-6 text-gray-900 dark:text-gray-100">
        <h1 class="text-4xl font-bold mb-8 text-center text-indigo-600 dark:text-indigo-400">Terms of Service</h1>
        ...
        <div class="space-y-8">
            ...
            <div>
                <h2 class="text-xl font-semibold mb-2 text-indigo-600 dark:text-indigo-400">No guarantees</h2>
                <p>
            ...
            <div>
                <h2 class="text-xl font-semibold mb-2 text-indigo-600 dark:text-indigo-400">Your responsibility</h2>
                <p>
            ...
            <div>
                <h2 class="text-xl font-semibold mb-2 text-indigo-600 dark:text-indigo-400">No liability</h2>
                <p>
            ...
            <div>
                <h2 class="text-xl font-semibold mb-2 text-indigo-600 dark:text-indigo-400">Ephemeral nature</h2>
                <p>
            ...
            <div>
                <h2 class="text-xl font-semibold mb-2 text-indigo-600 dark:text-indigo-400">Content limitations</h2>
                <p>
