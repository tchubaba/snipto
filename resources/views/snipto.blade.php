...
@section('content')
    ...
    >
        ...
        <x-warning-modal 
            show="showWeakPasswordModal"
            title="{!! __('Caution: Weak Password Detected') !!}"
            cancelAction="closeWeakPasswordModal()"
            cancelText="{!! __('Go back and change') !!}"
            confirmAction="submitSnipto(true)"
            confirmText="{!! __('Use anyway') !!}">
        ...
        <!-- Language Switcher Warning Modal -->
        <x-warning-modal 
            show="showLanguageWarningModal"
            title="{!! __('Wait! Have you copied your Snipto?') !!}"
            cancelAction="closeLanguageWarningModal()"
            cancelText="{!! __('Go Back') !!}"
            confirmAction="submitPendingLanguageForm()"
            confirmText="{!! __('Proceed') !!}">
            {!! __('Changing the language requires reloading the page. Because Sniptos are ephemeral, reloading will permanently erase it from your screen.') !!}
        </x-warning-modal>
    </div>
@endsection
